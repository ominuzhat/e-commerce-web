const EngTermsOfService = () => {
  return (
    <div className="my-5 space-y-10">
      <div className="space-y-5">
        <h1 className="text-2xl font-bold">Our Terms Of Service</h1>
        <p className="text-gray-500">
          ...
          tellus lacinia, a malesuada est sodales. Praesent at consectetur sem,
          sed scelerisque arcu. Maecenas malesuada lorem id sagittis
          scelerisque. In hac habitasse platea dictumst.
        </p>
      </div>
      <div className="space-y-5">
        <h1 className="text-2xl font-bold">When Customer Returns</h1>
        <p className="text-gray-500">
          Sed ac sollicitudin ipsum. Vivamus vulputate, enim sit amet aliquet
          lacinia, ex mauris aliquam elit, vel pharetra augue arcu ultricies
          magna. Suspendisse justo erat, dignissim ut imperdiet ut, convallis
      ...
      <div className="space-y-5">
        <h1 className="text-2xl font-bold">Faulty Products</h1>
        <p className="text-gray-500">
          Sed ac sollicitudin ipsum. Vivamus vulputate, enim sit amet aliquet
          lacinia, ex mauris aliquam elit, vel pharetra augue arcu ultricies
          magna. Suspendisse justo erat, dignissim ut imperdiet ut, convallis
      ...
      <div className="space-y-5">
        <h1 className="text-2xl font-bold">Damaged Appliances</h1>
        <p className="text-gray-500">
          Sed ac sollicitudin ipsum. Vivamus vulputate, enim sit amet aliquet
          lacinia, ex mauris aliquam elit, vel pharetra augue arcu ultricies
          magna. Suspendisse justo erat, dignissim ut imperdiet ut, convallis
      ...
      <div className="space-y-5">
        <h1 className="text-2xl font-bold">Hyperlinking to our Content</h1>
        <p className="text-gray-500">
          Sed ac sollicitudin ipsum. Vivamus vulputate, enim sit amet aliquet
        </p>
        <ul className="space-y-3 ms-10 text-gray-500">
          <li>1. Ut scelerisque hendrerit venenatis</li>
          <li>2. Ut scelerisque hendrerit venenatis</li>
          <li>3. Ut scelerisque hendrerit venenatis</li>
          <li>4. Ut scelerisque hendrerit venenatis</li>
          <li>5. Ut scelerisque hendrerit venenatis</li>
        </ul>
      </div>
      <div className="space-y-5">
...
export default EngTermsOfService;
